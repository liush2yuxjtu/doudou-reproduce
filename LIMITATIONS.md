...
- This is a local interview demo, not a packaged or notarized macOS release.
...
- TTS is local browser speech synthesis and may vary by machine.
- The advisor is intentionally conservative: if evidence is stale or unsupported, the response is blocked.
